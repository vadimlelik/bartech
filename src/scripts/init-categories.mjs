...
const categories = [
    {
        ...
        metadata: {
            ...
            description: 'Широкий выбор iPhone. Все модели в наличии. Быстрая доставка.',
    ...
    },
    {
        ...
        metadata: {
            ...
            description: 'Широкий выбор Samsung Galaxy. Все модели в наличии. Быстрая доставка.',
    ...
    },
    {
        ...
        metadata: {
            ...
            description: 'Широкий выбор Xiaomi. Все модели в наличии. Быстрая доставка.',
...
async function initCategories() {
    ...
    try {
        ...
        if (existingCategories === 0) {
            ...
            console.log(`Successfully initialized ${result.insertedCount} categories`)
        } else {
