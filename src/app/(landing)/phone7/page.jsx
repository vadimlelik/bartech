...
import { PIXEL } from '@/shared/config/pixel';
  ...
  const handleQuizSubmit = async (data) => {
    ...
    try {
      ...
      if (response.data?.success) {
        router.push('https://technobar.by/thank-you?source=mobile_1');
      } else {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <ul className={styles.benefits}>
            ...
            <li> Без справок о доходе и 1-го платежа</li>
            <li> Начало оплаты только со 2-го месяца</li>
            <li> В наличии более 1000 моделей</li>
            <li> Мы одобряем 98% подаваемых заявок</li>
        ...
        <div className={styles.heroImage}>
          <Image
            src="/images/mobile/mobile_1.jpeg"
            alt="Телефоны"
            width={500}
            height={1000}
            priority
      ...
      <div className={styles.advantagesSection}>
        <div className={styles.advantagesImage}>
          <Image
            src="/images/mobile/mobile_2.jpg"
            alt="Смартфоны"
            width={500}
            height={1000}
            loading="lazy"
