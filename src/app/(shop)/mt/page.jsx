...
export default function ProductsPage() {
  return (
    <main className={styles.container}>
      <h1 className={styles.title}>Список мотоблоков</h1>
      ...
      <section className={styles.paymentOptions}>
        <div className={styles.paymentHeader}>
          ...
          <h2 className={styles.paymentTitle}>Доступные варианты оплаты</h2>
        </div>
        <div className={styles.paymentTags}>
          <span className={styles.paymentTag}>в рассрочку</span>
          <span className={styles.paymentTag}>в кредит</span>
          <span className={styles.paymentTag}>в лизинг</span>
        </div>
      </section>
    </main>
  );
